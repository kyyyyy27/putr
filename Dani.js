		...
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 's̸o̸u̸r̸c̸e̸ c̸o̸d̸e̸',
                                    url: 'NYARI SC? RECODE SENDIRI BG:V'
                                }
                            }, {
                                callButton: {
                                    displayText: 'n̸u̸m̸b̸e̸r̸ p̸h̸o̸n̸e̸ o̸w̸n̸e̸r̸',
                                    phoneNumber: '+62 812-5154-9899'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 's̸t̸a̸t̸u̸s̸ b̸o̸t̸',
                                    id: 'p̸i̸n̸g̸'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'c̸o̸n̸t̸a̸c̸t̸ o̸w̸n̸e̸r̸',
                                    id: 'o̸w̸n̸e̸r̸'
                                }  
                            }, {
                                quickReplyButton: {
                                    displayText: 's̸c̸r̸i̸p̸t̸',
                                    id: 's̸c̸'
                                }
                            }]
